    ...
    return (
        ...
        >
            ...
            <div className="flex items-start gap-3">
                <div
                    className={`mt-0.5 w-4 h-4 rounded-full border-2 flex-shrink-0 flex items-center justify-center ${selected ? "border-brand bg-brand" : "border-white/30"
                        }`}
                >
...
function CheckCard({
    ...
    return (
        <button
            onClick={onClick}
            className={`w-full text-left p-4 rounded-xl border-2 transition-all duration-200 ${checked
        ...
        >
            <div className="flex items-start gap-3">
                <div
                    className={`mt-0.5 w-4 h-4 rounded-md border-2 flex-shrink-0 flex items-center justify-center ${checked ? "border-brand bg-brand" : "border-white/30"
                        }`}
                >
                    {checked && (
                    ...
                    {STEPS.map((s, i) => {
                        ...
                        return (
                            <button
                                ...
                                onClick={() => setStep(i)}
                                title={s.title}
                                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium whitespace-nowrap transition-colors flex-shrink-0 ${i === step
